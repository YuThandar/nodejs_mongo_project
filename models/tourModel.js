...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      // validate: [validator.isAlpha, 'Tour name must only contain characters'], // only letter not accpet space
    },
    slug: String,
    duration: {
      type: Number,
    ...
    difficulty: {
      ...
      enum: {
        values: ['easy', 'medium', 'difficultly'],
        message: 'Difficultly is either: easy, medium, difficult',
      },
    },
    ratingsAverage: {
      type: Number,
    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          // this only points to current doc on NEW document creation (not include update)
